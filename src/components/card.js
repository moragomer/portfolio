...
function Card({ cardsData }) {
    ...
    return (react_1.default.createElement("div", { style: {
        ...
        react_1.default.createElement("div", { style: {
            ...
            react_1.default.createElement("img", { src: imgs[Math.floor(Math.random() * imgs.length)], width: "100%", borderRadius: "16px", display: "block" })),
        ...
        react_1.default.createElement("div", { style: {
            ...
            react_1.default.createElement(input_1.Flex, { gap: spacing_1.default.s, justifyContent: "space-between" },
                react_1.default.createElement(input_1.Flex, { gap: spacing_1.default.s },
                    " ",
                    react_1.default.createElement(buttons_1.Button, { variant: "tertiary", bottonSize: "sBlg" },
